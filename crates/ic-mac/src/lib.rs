...
//!
//! * [`Hmac`] — FIPS 198-1, generic over any [`Digest`](ic_core::traits::Digest) in `ic-hash`.
//! * [`CmacAes128`] / [`CmacAes256`] — SP 800-38B CMAC over AES.
//! * [`Poly1305`] — re-exported from `ic-cipher` for one-time authentication.
//!
//! All verification goes through [`ic_core::ct::verify`], so tag comparison
