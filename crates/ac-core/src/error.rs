...
/// Result alias used by every fallible operation in AgenticCrypto.
...
/// (`ac-ontology::error_catalog`) so an agent can reason about recovery
...
/// A failure from any AgenticCrypto operation.
///
