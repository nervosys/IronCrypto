...
//!
//! AgenticCrypto never uses raw OS bytes as key material directly. The OS
//! source is treated as the *entropy input* to an SP 800-90A DRBG
//! (`ac-drbg`), which is the construction FIPS 140-3 expects. This module only
...
///
/// ```no_run
/// use ac_core::{entropy::OsEntropy, traits::RandomSource};
/// let mut seed = [0u8; 48];
