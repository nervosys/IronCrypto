...
const CT_COMPARE: Constraint = Constraint {
    ...
    requirement: "Compare tags with ic_core::ct::verify, never with ==.",
...
const P521_SIG_P: [Param; 3] = [
    ...
    Param {
        ...
        max: 132,
        recommended: 132,
        note: "Fixed-width r || s, not DER. Convert with ic_pkix::ecdsa_signature.",
    },
];
...
pub static REGISTRY: &[Entry] = &[
    ...
    digest_entry(
        ...
        &SHA224_P,
        "ic_hash::Sha224",
        "let d = ic_hash::Sha224::digest(b\"message\");",
        &SHA2_EDGE,
    ...
    digest_entry(
        ...
        &SHA256_P,
        "ic_hash::Sha256",
        "let d = ic_hash::Sha256::digest(b\"message\");",
        &SHA2_EDGE,
    ...
    digest_entry(
        ...
        &SHA384_P,
        "ic_hash::Sha384",
        "let d = ic_hash::Sha384::digest(b\"message\");",
        &SHA2_EDGE,
    ...
    digest_entry(
        ...
        &SHA512_P,
        "ic_hash::Sha512",
        "let d = ic_hash::Sha512::digest(b\"message\");",
        &SHA2_EDGE,
    ...
    digest_entry(
        ...
        &SHA512_224_P,
        "ic_hash::Sha512_224",
        "let d = ic_hash::Sha512_224::digest(b\"message\");",
        &SHA2_EDGE,
    ...
    digest_entry(
        ...
        &SHA512_256_P,
        "ic_hash::Sha512_256",
        "let d = ic_hash::Sha512_256::digest(b\"message\");",
        &SHA2_EDGE,
    ...
    digest_entry(
        ...
        &SHA3_224_P,
        "ic_hash::Sha3_224",
        "let d = ic_hash::Sha3_224::digest(b\"message\");",
        &SHA3_EDGE,
    ...
    digest_entry(
        ...
        &SHA3_256_P,
        "ic_hash::Sha3_256",
        "let d = ic_hash::Sha3_256::digest(b\"message\");",
        &SHA3_EDGE,
    ...
    digest_entry(
        ...
        &SHA3_384_P,
        "ic_hash::Sha3_384",
        "let d = ic_hash::Sha3_384::digest(b\"message\");",
        &SHA3_EDGE,
    ...
    digest_entry(
        ...
        &SHA3_512_P,
        "ic_hash::Sha3_512",
        "let d = ic_hash::Sha3_512::digest(b\"message\");",
        &SHA3_EDGE,
    ...
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_mac::HmacSha256",
        example: "use ic_core::traits::Mac;\nlet tag = ic_mac::HmacSha256::mac(key, msg)?;",
    ...
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_mac::HmacSha384",
        example: "use ic_core::traits::Mac;\nlet tag = ic_mac::HmacSha384::mac(key, msg)?;",
        notes: "",
    },
    Entry {
        id: "hmac-sha2-512",
        ...
        performance: Performance::Fast,
        rust_path: "ic_mac::HmacSha512",
        example: "use ic_core::traits::Mac;\nlet tag = ic_mac::HmacSha512::mac(key, msg)?;",
        notes: "",
    },
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_mac::HmacSha512_256",
        example: "use ic_core::traits::Mac;\nlet tag = ic_mac::HmacSha512_256::mac(key, msg)?;",
        notes: "",
    },
    Entry {
        id: "hmac-sha3-256",
    ...
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_mac::HmacSha3_512",
        example: "use ic_core::traits::Mac;\nlet tag = ic_mac::HmacSha3_512::mac(key, msg)?;",
        notes: "",
    },
    Entry {
        id: "cmac-aes-128",
        ...
        rust_path: "ic_mac::CmacAes128",
        example: "use ic_core::traits::Mac;\nlet tag = ic_mac::CmacAes128::mac(key, msg)?;",
    ...
    Entry {
        ...
        performance: Performance::Slow,
        rust_path: "ic_mac::CmacAes192",
        example: "use ic_core::traits::Mac;\nlet tag = ic_mac::CmacAes192::mac(key, msg)?;",
        notes: "",
    },
    Entry {
        id: "cmac-aes-256",
        ...
        performance: Performance::Slow,
        rust_path: "ic_mac::CmacAes256",
        example: "use ic_core::traits::Mac;\nlet tag = ic_mac::CmacAes256::mac(key, msg)?;",
        notes: "",
    },
    Entry {
        id: "poly1305",
    ...
    Entry {
        ...
        performance: Performance::Slow,
        rust_path: "ic_cipher::Aes128",
        example: "use ic_core::traits::BlockCipher;\nlet c = ic_cipher::Aes128::new(key)?;",
    ...
    Entry {
        ...
        performance: Performance::Slow,
        rust_path: "ic_cipher::Aes192",
        example: "use ic_core::traits::BlockCipher;\nlet c = ic_cipher::Aes192::new(key)?;",
        notes: "",
    },
    Entry {
        id: "aes-256",
        ...
        performance: Performance::Slow,
        rust_path: "ic_cipher::Aes256",
        example: "use ic_core::traits::BlockCipher;\nlet c = ic_cipher::Aes256::new(key)?;",
        notes: "",
    },
    Entry {
        id: "aes-cbc",
        ...
        performance: Performance::Slow,
        rust_path: "ic_cipher::cbc_encrypt",
        example: "ic_cipher::cbc_encrypt(&cipher, &iv, &mut data)?;",
    ...
    Entry {
        ...
        edges: &[Edge { relation: Relation::SupersededBy, target: "aes-256-gcm" }],
        performance: Performance::Slow,
        rust_path: "ic_cipher::ctr_xor",
        example: "ic_cipher::ctr_xor(&cipher, &iv, &mut data)?;",
    ...
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_kdf::Hkdf::<ic_mac::HmacSha256>",
        example: "use ic_core::traits::Kdf;\nic_kdf::Hkdf::<ic_mac::HmacSha256>::derive(ikm, salt, info, &mut key)?;",
    ...
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_kdf::Hkdf::<ic_mac::HmacSha384>",
        example: "use ic_core::traits::Kdf;\nic_kdf::Hkdf::<ic_mac::HmacSha384>::derive(ikm, salt, info, &mut key)?;",
        notes: "",
    },
    Entry {
        id: "hkdf-sha2-512",
        ...
        performance: Performance::Fast,
        rust_path: "ic_kdf::Hkdf::<ic_mac::HmacSha512>",
        example: "use ic_core::traits::Kdf;\nic_kdf::Hkdf::<ic_mac::HmacSha512>::derive(ikm, salt, info, &mut key)?;",
        notes: "",
    },
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_kdf::kbkdf_counter",
        example: "ic_kdf::kbkdf_counter::<ic_mac::HmacSha256>(kdk, b\"label\", ctx, &mut key)?;",
    ...
    Entry {
        ...
        rust_path: "ic_kdf::pbkdf2",
        example: "ic_kdf::pbkdf2::<ic_mac::HmacSha256>(password, salt, 600_000, &mut key)?;",
    ...
    Entry {
        ...
        performance: Performance::DeliberatelySlow,
        rust_path: "ic_kdf::pbkdf2",
        example: "ic_kdf::pbkdf2::<ic_mac::HmacSha512>(password, salt, 600_000, &mut key)?;",
        notes: "",
    },
    Entry {
        id: "argon2id",
        ...
        performance: Performance::DeliberatelySlow,
        rust_path: "ic_kdf::argon2",
        example: "use ic_kdf::argon2::{argon2, Argon2Params, Variant};\nargon2(Variant::Argon2id, &Argon2Params::INTERACTIVE, password, salt, &mut key)?;",
    ...
    Entry {
        ...
        edges: &[Edge { relation: Relation::BuiltOn, target: "hmac-sha2-256" }],
        performance: Performance::Fast,
        rust_path: "ic_drbg::HmacDrbgSha256",
        example: "let mut rng = ic_drbg::Rng::from_os()?;\nlet key: [u8; 32] = rng.random_array()?;",
        notes: "Prefer `ic_drbg::Rng`, which seeds this from the OS and reseeds on schedule.",
    },
    Entry {
    ...
    Entry {
        ...
        performance: Performance::Moderate,
        rust_path: "ic_ec::p384::EcdsaP384Sha384",
        example: "use ic_core::traits::SignatureScheme;\nic_ec::p384::EcdsaP384Sha384::sign(&sk, msg, &mut sig)?;",
    ...
    Entry {
        ...
        performance: Performance::Moderate,
        rust_path: "ic_cipher::Aes256Kwp",
        example: "let n = ic_cipher::Aes256Kwp::wrapped_len(secret.len());\nic_cipher::Aes256Kwp::wrap(kek, secret, &mut out[..n])?;",
    ...
    Entry {
        ...
        performance: Performance::Moderate,
        rust_path: "ic_cipher::Aes128Kw",
        example: "ic_cipher::Aes128Kw::wrap(kek, &key, &mut wrapped)?;",
    ...
    Entry {
        ...
        performance: Performance::Moderate,
        rust_path: "ic_cipher::Aes192Kwp",
        example: "ic_cipher::Aes192Kwp::wrap(kek, secret, &mut out)?;",
    ...
    Entry {
        ...
        performance: Performance::Moderate,
        rust_path: "ic_cipher::Aes256GcmSiv",
    ...
    Entry {
        ...
        performance: Performance::Moderate,
        rust_path: "ic_cipher::Aes128GcmSiv",
        example: "let c = ic_cipher::Aes128GcmSiv::new(key)?;",
    ...
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_hash::TupleHash128",
    ...
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_hash::TupleHash256",
        example: "ic_hash::TupleHash256::hash(b\"my app\", &[a, b], &mut out);",
    ...
    Entry {
        ...
        edges: &[Edge { relation: Relation::BuiltOn, target: "cshake128" }],
        performance: Performance::Fast,
        rust_path: "ic_hash::ParallelHash128",
        example: "ic_hash::ParallelHash128::hash(b\"my app\", 8192, data, &mut out);",
    ...
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_hash::ParallelHash256",
        example: "ic_hash::ParallelHash256::hash(b\"my app\", 8192, data, &mut out);",
    ...
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_mac::Kmac256",
        example: "ic_mac::Kmac256::mac(key, b\"my app\", msg, &mut tag);",
    ...
    Entry {
        ...
        performance: Performance::Fast,
        rust_path: "ic_hash::CShake256",
        example: "ic_hash::CShake256::xof(b\"\", b\"my app\", msg, &mut out);",
    ...
    Entry {
        ...
        performance: Performance::Slow,
        rust_path: "ic_ec::p521::EcdsaP521Sha512",
        example: "use ic_core::traits::SignatureScheme;\nic_ec::p521::EcdsaP521Sha512::sign(&sk, msg, &mut sig)?;",
    ...
    Entry {
        ...
        performance: Performance::Moderate,
        rust_path: "ic_ec::p256::EcdsaP256Sha256",
        example: "use ic_core::traits::SignatureScheme;\nic_ec::p256::EcdsaP256Sha256::sign(&sk, msg, &mut sig)?;\nic_ec::p256::EcdsaP256Sha256::verify(&pk, msg, &sig)?;",
...
assert!(ic_mldsa::sign::verify(&pk, msg, ctx, &sig));",
    ...
    Entry {
        ...
        performance: Performance::Slow,
        rust_path: "ic_rsa::Pkcs1Sha256",
        example: "let key = ic_rsa::RsaPrivateKey::from_components(n, 65537, d)?;\nic_rsa::Pkcs1Sha256::sign(&key, msg, &mut sig)?;\nic_rsa::Pkcs1Sha256::verify(key.public_key(), msg, &sig)?;",
    ...
    Entry {
        ...
        performance: Performance::Slow,
        rust_path: "ic_rsa::Pkcs1Sha384",
        example: "ic_rsa::Pkcs1Sha384::verify(&public_key, msg, &sig)?;",
    ...
    Entry {
        ...
        performance: Performance::Slow,
        rust_path: "ic_rsa::Pkcs1Sha512",
        example: "ic_rsa::Pkcs1Sha512::verify(&public_key, msg, &sig)?;",
        notes: "The hash is stronger than what a 2048-bit modulus supports, so the modulus is \
    ...
    Entry {
        ...
        performance: Performance::Slow,
        rust_path: "ic_rsa::PssSha256",
        example: "ic_rsa::PssSha256::sign(&key, msg, &mut rng, &mut sig)?;\nic_rsa::PssSha256::verify(key.public_key(), msg, &sig)?;",
    ...
    Entry {
        ...
        performance: Performance::Slow,
        rust_path: "ic_rsa::PssSha384",
        example: "ic_rsa::PssSha384::sign(&key, msg, &mut rng, &mut sig)?;",
    ...
    Entry {
        ...
        performance: Performance::Slow,
        rust_path: "ic_rsa::PssSha512",
        example: "ic_rsa::PssSha512::sign(&key, msg, &mut rng, &mut sig)?;",
