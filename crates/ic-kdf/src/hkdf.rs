...
use ic_core::traits::{Algorithm, Kdf, Mac, SelfTest};
...
impl SelfTest for Hkdf<ic_mac::HmacSha256> {
    fn self_test() -> Result<()> {
        // RFC 5869 test case 1.
        let ikm = [0x0bu8; 22];
        let mut salt = [0u8; 13];
        ic_core::codec::hex_decode(b"000102030405060708090a0b0c", &mut salt)?;
        let mut info = [0u8; 10];
        ic_core::codec::hex_decode(b"f0f1f2f3f4f5f6f7f8f9", &mut info)?;
