...
use ac_core::traits::{Algorithm, Digest, SelfTest};
...
mod tests {
    ...
    fn nist_abc_vectors() {
        assert_eq!(
            ac_core::codec::hex(Sha256::digest(b"abc").as_ref()),
            "ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad"
        );
        assert_eq!(
            ac_core::codec::hex(Sha224::digest(b"abc").as_ref()),
            "23097d223405d8228642a477bda255b32aadbce4bda0b3f7e36c9da7"
        );
        assert_eq!(
            ac_core::codec::hex(Sha512::digest(b"abc").as_ref()),
            "ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f"
        );
        assert_eq!(
            ac_core::codec::hex(Sha384::digest(b"abc").as_ref()),
            "cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7"
        );
    }
    ...
    fn empty_input_vectors() {
        assert_eq!(
            ac_core::codec::hex(Sha256::digest(b"").as_ref()),
            "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
        );
        assert_eq!(
            ac_core::codec::hex(Sha512::digest(b"").as_ref()),
    ...
    fn two_block_vector() {
        ...
        assert_eq!(
            ac_core::codec::hex(Sha256::digest(msg).as_ref()),
    ...
    fn million_a_vector() {
        ...
        assert_eq!(
            ac_core::codec::hex(h.finalize().as_ref()),
    ...
    fn truncated_variants() {
        assert_eq!(
            ac_core::codec::hex(Sha512_224::digest(b"abc").as_ref()),
            "4634270f707b6a54daae7530460842e20e37ed265ceee9a43e8924aa"
        );
        assert_eq!(
            ac_core::codec::hex(Sha512_256::digest(b"abc").as_ref()),
            "53048e2681941ef99b2e29b76b4c7dabe4c2d0c634fc6d46e0e2f13107e7af23"
        );
    }
