//! # ac-ontology — the machine-readable cryptographic ontology
//!
//! This crate is what makes AgenticCrypto *agentic-first*. A conventional
...
/// The error catalog, mirroring [`ac_core::ErrorKind`].
///
...
pub mod errors {
    ...
    pub struct ErrorDoc {
        /// Stable identifier, matching [`ac_core::ErrorKind::id`].
        pub id: &'static str,
    ...
    const KINDS: &[(ErrorKind, &str, &str)] = &[
        ...
        (
            ...
            "This is a bug in AgenticCrypto. Report it with the context string.",
        ),
    ];
