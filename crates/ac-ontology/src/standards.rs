...
const FIPS186_REQS: [Requirement; 2] = [
    Requirement {
        ...
        compliance: Compliance::Met {
            file: "crates/ac-ec/src/nist/ecdsa.rs",
            symbol: "bits2int",
        },
    },
    Requirement {
        ...
        compliance: Compliance::Met {
            file: "crates/ac-ec/src/nist/point.rs",
            symbol: "is_on_curve",
        },
    },
];
...
const FIPS140_REQS: [Requirement; 6] = [
    ...
    Requirement {
        ...
        applies_to: &[],
        compliance: Compliance::Met {
            file: "crates/ac-fips/src/lib.rs",
    ...
    Requirement {
        ...
        applies_to: &[],
        compliance: Compliance::Met {
            file: "crates/ac-ontology/src/runtime.rs",
...
const SP80090A_REQS: [Requirement; 3] = [
    ...
    Requirement {
        ...
        applies_to: &["ctr-drbg-aes-256"],
        compliance: Compliance::Met {
            file: "crates/ac-drbg/src/rng.rs",
            symbol: "from_entropy",
        },
    },
];
...
const RFC8017_REQS: [Requirement; 1] = [Requirement {
    ...
    compliance: Compliance::Met {
        file: "crates/ac-rsa/src/pkcs1.rs",
