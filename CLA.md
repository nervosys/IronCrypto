...
artwork, or other materials) to this Project, you agree to the following terms:

## 1. Definitions

- **"Contribution"** means any original work of authorship, including modifications
  or additions to an existing work, that you intentionally submit to the Project.
- **"Submit"** means any form of communication sent to the Project (e.g., pull request,
  patch, issue comment, mailing list message), excluding communications clearly
  marked "Not a Contribution."

## 2. Grant of Copyright License

You hereby grant to the Organization and recipients of software distributed by
the Organization a perpetual, worldwide, non-exclusive, no-charge, royalty-free,
...
Contribution(s) alone or by combination with the Project.

## 4. Dual-Licensing Authorization

You acknowledge and agree that your Contributions may be distributed under both:

1. The **GNU Affero General Public License v3** (AGPL-3.0-or-later), and
2. A **commercial license** offered by the Organization.

This dual-licensing model enables the Project to remain open source while also
being available under commercial terms for organizations whose use cases are
...
extent you desire to do so. Support may be provided for free, for a fee, or
not at all.

## 7. No Obligation

The Organization is under no obligation to accept or include any Contribution.

---

## How to Sign

By submitting a pull request to this repository, you indicate your agreement to
