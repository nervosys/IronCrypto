...
| `ac-mldsa` | ML-DSA's ring Z_q[X]/(X^256+1) with q = 8380417, its NTT, the rejection-bound check, and the rounding/hint functions (FIPS 204 alg. 35-40). No signature scheme yet |
